 ...
 * Http request. 
 * 
 * @see a similar implementation in the legacy resource adapter as well.  Changes made here should be mader there and vice versa.
 *
 */
class DataProtocolQueryStrategy implements PartialResultExecutor {
    
    private static GoogleJSONParser PARSER = new GoogleJSONParser();
    
    private final OAuth2HeaderFactory authHeaderFactory;
    private String spreadsheetKey;
    private String worksheetName;
    private String urlEncodedQuery;
    private List<Column> metadata;
    
    public DataProtocolQueryStrategy(OAuth2HeaderFactory authHeaderFactory, String key, String worksheetKey,
            String query) {
        super();
    ...
    public List<SheetRow> getResultsBatch(int startIndex, int amount) {
        ...
        get.setHeader("Authorization", authHeaderFactory.getAuthHeader()); //$NON-NLS-1$
